...
{
    public class SilverLanguageService : Microsoft.VisualStudio.Package.LanguageService
    {
        ...
        public override LanguagePreferences GetLanguagePreferences()
        {
            if (this.preferences == null)
            {
                this.preferences = new LanguagePreferences(this.Site,
                                                        typeof(SilverLanguageServicePackage).GUID,
                                                        this.Name);
        ...
        public override Microsoft.VisualStudio.Package.AuthoringScope ParseSource(ParseRequest req)
        {
            ...
            switch (req.Reason)
            {
                case ParseReason.Check:
                    ...
                    var node = parser.Parse(req.Text, req.FileName).Root.AstNode;
