...
namespace Sharpsilver.VisualStudioPlugin
{
    ...
    public class SharpsilverVisualStudioPluginAnalyzer : DiagnosticAnalyzer
    {
        ...
        private static DiagnosticDescriptor Rule2 = new DiagnosticDescriptor("CSSIL502", "The 'switch' keyword is not permitted.", "You should remove the 'switch' keyword.", "Sharpsilver Translation", DiagnosticSeverity.Error, true);
