    ...
    public class IronyPackage : Microsoft.VisualStudio.Shell.Package, IOleComponent
    {
        ...
        public IronyPackage()
        {
            ServiceCreatorCallback callback = new ServiceCreatorCallback(
                ...
                {
                    if (typeof(SilverLanguageService) == serviceType)
                    {
                        SilverLanguageService language = new SilverLanguageService();
            ...
            (this as IServiceContainer).AddService(typeof(SilverLanguageService), callback, true);
        }
        ...
        {
            SilverLanguageService ls = GetService(typeof(SilverLanguageService)) as SilverLanguageService;
